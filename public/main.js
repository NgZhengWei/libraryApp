...
document.querySelector('.project-context-display').addEventListener('click', e => {
    document.querySelector('.project-content-dropdown').classList.toggle('invisible');
});

document.querySelector('.project-manual-display').addEventListener('click', e => {
    document.querySelector('.project-manual-dropdown').classList.toggle('invisible');
});
